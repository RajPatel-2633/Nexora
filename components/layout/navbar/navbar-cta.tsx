  ...
  return (
    ...
    >
      <Button
        ...
        size="sm"
        className={cn(
          "group relative overflow-hidden text-sm font-semibold transition-all duration-300 h-10 px-5 rounded-lg",
          isScrolled ? "shadow-lg shadow-brand-500/30" : "shadow-md shadow-brand-500/20",
          className
        )}
      >
